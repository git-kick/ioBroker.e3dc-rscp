		...
		if ( this.adapter.config.query_wb ) {
			...
			this.adapter.setObjectNotExists( wbPath + ".Control.SunMode", {
				...
				common: {
					...
					write: true,
					unit: "",
					states: this.adapter.rscpWbSunmode,
					def: 0
				},
				native: {},
			} );
			...
			this.adapter.setObjectNotExists( wbPath + ".EXTERN_DATA_ALG.Typ2Locked", {
				...
				common: {
					...
					write: false,
					unit: "",
					states: this.adapter.rscpWbTyp2Locked,
					def: 0
				},
				native: {},
			} );
			this.adapter.setObjectNotExists( wbPath + ".EXTERN_DATA_ALG.ActivePhases", {
				...
				common: {
					...
					write: false,
					unit: "",
					states: this.adapter.rscpWBActivePhases,
					def: 0
				},
				native: {},
			} );
...
wallbox.rscpWbTyp2Locked = {
	0: "UNLOCKED",
	1: "LOCKED",
	16: "NOT_CONNECTED"
};

wallbox.rscpWbSunmode = {
	"1": "SUNMODE",
	"2": "MIXEDMODE",
};

wallbox.rscpWbPrecharge = {
	"1": "+5%",
	"2": "-5%",
};

wallbox.rscpWBActivePhases = {
	1: "1-Phase",
	3: "3-Phase",
};
